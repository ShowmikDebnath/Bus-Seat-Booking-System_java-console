...
public class Admin{     
    ...
    void positive_validaty_taka(int fare_selected_by_admin) throws ArithmeticException{ // admin exception hadling for making any fare positive .. if admin select a negetive fare than the program will allert this 
        if(fare_selected_by_admin < 0){
            throw new ArithmeticException("\t\t\t\t\t\t\t\t\t\t\t\tnegetive number cann't be a fare");
        }
        else{
            System.out.println("");
        }
    ...
    Admin(String Admin_can_change_all_information){
        ...
        for (int again = 0; again==0; ){
            ...
            System.out.println("\n\t\t\t\t\t\t\t\t\t\t\t\tDo you want to change any fare of any roots?");
            ...
            if(choice == 1){
                ...
                if(n2 == 1){
                    try{
                    System.out.print("\t\t\t\t\t\t\t\t\t\t\t\t\tPlease enter new fare : ");
                    int fare = sc.nextInt();
                    System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t~~~~ Change Fare Successfully ~~~~");
                    System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t*******************************************************************");
                    positive_validaty_taka(fare);
                    System.out.println("*******************************************************************");
                    this.fare11 = fare;
                    this.fare21 = fare;
                    this.fare31 = fare;
                    ...
                    System.out.println("Please enter a positive number. The fare is not selected");
                }
                }
                else if(n2 == 2){
                try{
