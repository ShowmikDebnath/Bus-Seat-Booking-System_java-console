...
public class Main
{
    ...
    static void Admin_display(){
        System.out.println("\n\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t***** Admin Portal *****");
        //System.out.println("\n\t\t\t\t\t\t\tView history and All information:");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t...................................................");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t\t1. All registered member's information:");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t *******************************************************************************\n");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t *                                                                             *\n");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t *                         BUS SEAT BOOKING SYSTEM                             *\n");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t *                                                                             *\n");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t *******************************************************************************\n");
        ...
        for (int i = 0; i == 0 ; ){
            //System.out.println("Registered people : "+ name.size());   // Registerd people not visible
            //System.out.println("Booked seats      : "+ seat.size());   // Booked info not visible
            ...
            if (user == 1){                                                 // registration
                ...
                System.out.print("\n\t\t\t\t\t\t\t\t\t\t\t\t->\tUser name : ");
                String userName = sc.nextLine(); // username
                System.out.print("\t\t\t\t\t\t\t\t\t\t\t\t->\tPassword (minimum 6 character) : ");
                String pass = sc.nextLine();      // Password
...
//<<<<<<< HEAD
                    System.out.print("\t\t\t\t\t\t\t\t\t\t\t\t->\tPhone: +880 1");
//=======
                    //System.out.print("Phone (must be a valid num of 11 digit)  : 01");
//>>>>>>> bcfb41cc5fe7f0bd5360182da324c9650104a33d
                    ...
                    if(ph.length() == 9){
                        ...
                        )
                        {
                            ...
                            */
                            ...
                            System.out.println("\n\t\t\t\t\t\t\t\t\t\t\t\t# Please entered a valid number. You are not registerd.");
                        }
                    } // if(ph.length() == 9)
                    else{
                        System.out.println("\n\t\t\t\t\t\t\t\t\t\t\t\t# You entered a wrong number. You are not registared.");
                    }
                ...
                if( (name2.equals("a") && (pass2.equals(newpass1.admin_pass_real))) ){                  // admin log in
                    ...
                    for (int again = 0; again == 0; ){
                        System.out.print("\t\t\t\t\t\t\t\t\t\t\t\t\tAdmin's choice: ");
                        int admin_choice = sc.nextInt(); //admin choice
                        //System.out.println("**********");
                        ...
                        if(admin_choice == 1){                                                   // Passenger information
                            ...
                            if(add_all_delete == 1){
                                System.out.println("\n\t\t\t\t\t\t\t\t\t\t\t\t\t~~~~ You cleared all information ~~~~");             // delete all information from register list
                                name.clear();
                                password.clear();
                                realName.clear();
                                phone.clear();
                    ...
                    for(int j = size3-1; j>=0; j--){                            // this for searching if there is matched in user name and password then all function will execute
                        if(name2.equals(name.get(j)) && pass2.equals(password.get(j))){
                            ...
                            //System.out.println("Your password    :" + password.get(j)); // PASSWORD DOESNOT VISIBLE ALL TIME!
                            ...
                            for (int pass_again=0; pass_again==0 ; ) {
                                ...
                                if(buy_ticket == 1){
                                    ...
                                    System.out.print("\t\t\t\t\t\t\t\t\t\t\t\t\tEnter your choose (1-6):  ");
...
//>>>>>>> bcfb41cc5fe7f0bd5360182da324c9650104a33d
                ...
                System.out.println("\n\t\t\t\t\t\t\t\t\t\t\t\t# If you want to delete your all information deleted put your name and password");
...
//                System.out.println("\t\t\t\t******************************************************************************");
                ...
                System.out.println("\t\t\t\t\t\t\t\t\t\t\t|\t   Date       " + "  Destination     "+"   Available Seat    " + " Departure time" + "      Fare \t|\n");
